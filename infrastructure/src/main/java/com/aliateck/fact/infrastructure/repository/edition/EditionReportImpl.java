...
public class EditionReportImpl implements EditionReportService {	
  ...
  // infos company
    ...
    String fileName = FACTURE_LIBELLE 
...
@Override 
public byte[] buildPdfFacture(Map<String, Object> paramJasper, String path){	
	...
	byte [] pdfByte = null;
	    ...
	    try {   
		      ...
		      JasperExportManager.exportReportToPdfFile(jasperPrint, path+"/"+outputFileName+TYPE_FILE);	      
