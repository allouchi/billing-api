...
VALUES (2, '92500', 'Rueil-Malmaison', '13', 'FRANCE', 'Domaine de la côte noire');
 ...
 INSERT INTO t_company (id, code_ape, numero_bic, numero_iban, numero_tva, rcsname, siret, socialreason, status, adresse_id)
...
INSERT INTO t_user (id, firstname, lastname, mail, password, company_id, user_role_id) 
