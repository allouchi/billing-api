...
INSERT INTO `billing-prod`.t_user (id, user_name, last_name, first_name, password, actived, company_id) 
...
INSERT INTO `billing-prod`.T_ADRESSE (id , code_postal , localite , numero , pays , rue)
...
INSERT INTO `billing-prod`.t_company (id, code_ape, numero_bic, numero_iban, numero_tva, rcsname, siret, social_reason, status, adresse_id)
...
INSERT INTO `billing-prod`.t_consultant( id,	last_name,	first_name,	email, fonction,	company_id)
