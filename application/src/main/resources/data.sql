...
INSERT INTO `billing-dev`.t_user (id, user_name, last_name, first_name, password, actived, company_id) 
...
INSERT INTO `billing-dev`.T_ADRESSE (id , code_postal , localite , numero , pays , rue)
...
INSERT INTO `billing-dev`.t_company (id, code_ape, numero_bic, numero_iban, numero_tva, rcsname, siret, social_reason, status, adresse_id)
...
INSERT INTO `billing-dev`.t_consultant( id,	last_name,	first_name,	email, fonction,	company_id)
