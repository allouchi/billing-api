...
public class PrestationController {
	...
	public ResponseEntity<Prestation> addPrestation(@RequestBody Prestation prestation, @PathVariable String siret,
			@PathVariable boolean templateChoice, @PathVariable Long moisPrestaId) {
	...
	public ResponseEntity<Prestation> updatePrestation(@RequestBody Prestation prestation, @PathVariable String siret
	...
	public ResponseEntity<Prestation> createFacture(@RequestBody Prestation prestationRequest,
			@PathVariable String siret, @PathVariable boolean templateChoice, @PathVariable Long moisPrestaId) {
