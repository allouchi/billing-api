...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Bean
	public DaoAuthenticationProvider authenticationProvider(UserApiDetailAdapter userApiDetailsAdapter) {
	 ...
	 * .authoritiesByUsernameQuery( "select user_name as principal, role_name as role from t_role where user_name=?" )
	 * .rolePrefix("ROLE_");
	 * 
	 */
