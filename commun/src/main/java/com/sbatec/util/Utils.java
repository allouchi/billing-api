...
public class Utils {
    ...
    private final String custDefaultTemplate = "data/defaultTemplate.jrxml";
    private final String suiviFacturation = "data/suivi-facturation.xls";
    ...
    public static String determinerMoisFacture() {
        ...
        formatMois =
                formatMois.substring(0, 1).toUpperCase() + formatMois.substring(1);
        return formatMois;
    }
