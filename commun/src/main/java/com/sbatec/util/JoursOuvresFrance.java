...
public class JoursOuvresFrance {
	 ...
	 *            la date de fin
	 * @param debutInclus
	 *            si la date de début est incluse dans le compte
	 * @param finIncluse
	 *            si la date de fin est incluse dans le compte
	 * @return le nombre de jours en semaine
	 */
	 ...
	 *            la date de fin
	 * @param debutInclus
	 *            si la date de début est incluse
	 * @param finIncluse
	 *            si la date de fin est incluse
	 * @return le nombre de jours
	 */
	public static long calculNombreJoursFeriesSemaine(final LocalDate debut, final LocalDate fin,
			final boolean debutInclus, final boolean finIncluse) {
		...
		return joursFeries.stream()
				...
				.filter(localDate -> localDate.isAfter(debut.minusDays(debutInclus ? 1 : 0))
						&& localDate.isBefore(fin.plusDays(finIncluse ? 1 : 0)))
				.count();
	}

	/**
	 * Calcul le nombre de jours ouvrés entre [debut ; fin[ C'est à dire les jours travaillés lorsqu'on enlève les
	...
	public static long calculJoursOuvres(final LocalDate debut, final LocalDate fin) {
		return calculJoursOuvres(debut, fin, true, true);
	}

	/**
	 * Calcul le nombre de jours ouvrés entre 2 dates C'est à dire les jours travaillés lorsqu'on enlève les week-ends
	 * et les jours fériés
	 * 
	 * @param debut
	 *            la date de début
	 ...
	 *            la date de fin
	 * @param debutInclus
	 *            si la date de debut est à compter
	 * @param finIncluse
	 *            si la date de fin est à compter
	 * @return le nombre de jours
	 */
	public static long calculJoursOuvres(final LocalDate debut, final LocalDate fin, final boolean debutInclus,
			final boolean finIncluse) {
		return calculJoursSemaine(debut, fin, debutInclus, finIncluse)
				- calculNombreJoursFeriesSemaine(debut, fin, debutInclus, finIncluse);
	}
	...
	/**
	 * Test si un jour est en semaine ou non Autrement dit, si un jour est un Lundi, un Mardi, un Mercredi, un Jeudi ou
	 * un Vendredi
	 * 
	 * @param date
	 *            le jour à tester
	 ...
	 * 
	 * @see <a href=https://fr.wikipedia.org/wiki/Calcul_de_la_date_de_P%C3%A2ques>Article Wikipedia sur le calcul de la
	 *      date de paques</a>
	 * @param annee
	 *            l'année
	...
	/**
	 * Donne la date du lundi de Pâques 1 jour après Pâques
	 * 
	 * @param annee
	 *            l'année
	...
	/**
	 * Donne la date l'ascension 39 jours après Pâques
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Donne la date du lundi de Pentecote 50 jours après Pâques
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Donne la date du jour de l'an 1er jour de l'année
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Fête du travail 1 Mai de l'année
	 * 
	 * @param annee
	 *            demandée
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Victoire des Alliés 8 Mai de l'année
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Fête Nationale 14 Juillet de l'année
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Toussaint 1 Novembre de l'année
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
	...
	/**
	 * Armistice 11 Novembre de l'année
	 * 
	 * @param annee
	 *            l'année
	 * @return une nouvelle instance de {@link LocalDate}
